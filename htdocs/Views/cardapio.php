	...
	<body>
        ...
        <div class="cardapio-corpo">
            ...
            <div class="pizza-cardapio">
                <p> <a href="Pizzas.php"> <img id="pizza-icon-cardapio" src="http://www.pizzarianovabelem.com.br/images/home-dest-pizza.png" alt="pizza">Pizzas</a></p>
                <p> <a href="PizzasDoces.php">  <img id="pizza-icon-cardapio" src="https://culinaria.culturamix.com/blog/wp-content/gallery/pizza-2/Ap-Pizzas-Cardapio-2.png" alt="Pizza Doces">Pizzas Doces</a></p>
                <p>  <a href="Bebidas.php"> <img id="pizza-icon-cardapio" src="https://distribuidorahideal.com.br/527-large_default/refri-coca-cola-350ml-c-12.jpg" alt="Bebidas">Bebidas</a></p>
                    <p>  <a href="Outros.php"> <img id="pizza-icon-cardapio" src="http://www.saboresabor.com.br/wp-content/uploads/2017/11/prato_coxinha.png" alt="Outros">Outros</a></p>
